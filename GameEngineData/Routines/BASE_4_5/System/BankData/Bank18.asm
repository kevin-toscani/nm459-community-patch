...
doTileObservationLogic:
    ...
    BEQ ObjectDoesNotObserveTiles
        ...
        doTileTrampoline:
            JMP (temp16) ;; This now does the action, and when it hits
                         ;; the RTS in that action, it will jump back to the
                         ;; last JSR it saw, which was doNewActionTrampoline...
                         ;; which will immediately jump to
